    ...
    public static final Supplier<CreativeModeTab> UNDEAD_NIGHTS_ITEMS_TAB = CREATIVE_MODE_TAB.register("undead_nights_items_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.SLIMY_ROTTEN_FLESH.get()))
                    ...
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(PotionContents.createItemStack(Items.POTION, ModPotions.STRONG_LURE_HORDE_POTION));
                        output.accept(PotionContents.createItemStack(Items.LINGERING_POTION, ModPotions.STRONG_LURE_HORDE_POTION));
                        output.accept(PotionContents.createItemStack(Items.SPLASH_POTION, ModPotions.STRONG_LURE_HORDE_POTION));
                        output.accept(PotionContents.createItemStack(Items.TIPPED_ARROW, ModPotions.STRONG_LURE_HORDE_POTION));

...
public class ModPotions {
    ...
    public static final RegistryObject<Potion> STRONG_LURE_HORDE_POTION = POTIONS.register("strong_lure_horde_potion",
            () -> new Potion(new MobEffectInstance(ModEffects.STRONG_LURE_HORDE.get(), UndeadNights.difficultyConfig.getCurrentDifficultyLevel().getDifficultySettingsLureEffect().getDurationForLureHordeEffect() * 2 * 20, 0)));

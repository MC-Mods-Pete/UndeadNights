...
public class ModPotions {
    ...
    public static RegistryEntry<Potion> registerPotion(String name, StatusEffectInstance statusEffectInstance) {
        return Registry.registerReference(Registries.POTION, Identifier.of(UndeadNights.MOD_ID, name), new Potion("lure_horde_potion", statusEffectInstance));
    }

    public static void registerPotions() {
        LURE_HORDE_POTION = registerPotion("lure_horde_potion", new StatusEffectInstance(ModEffects.LURE_HORDE, MainConfig.getDurationForLureHordeEffect() *20, 0));

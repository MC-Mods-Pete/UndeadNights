...
public class BreakBlockGoal extends Goal {
    ...
    public boolean canStart() {
        ...
        if (block instanceof AirBlock || block.canMobSpawnInside()) {
        ...
        if (MainConfig.getPrintDebugMessages()) {
            UndeadNights.LOGGER.info("Block {} time {} stage {}", world.getBlockState(targetBlock).getBlock(), world.getBlockState(targetBlock).getBlock().getHardness(), MainConfig.getHordeZombiesBlockBreakTier());
        }

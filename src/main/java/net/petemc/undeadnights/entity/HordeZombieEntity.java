...
public class HordeZombieEntity extends ZombieEntity {
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData) {
        ...
        Objects.requireNonNull(this.getAttributeInstance(EntityAttributes.GENERIC_MAX_HEALTH)).addPersistentModifier(new EntityAttributeModifier(Identifier.of(UndeadNights.MOD_ID, "horde_zombie_health_bonus"), MainConfig.getMaxHealthHordeZombies() - 20.0F, EntityAttributeModifier.Operation.ADD_VALUE));

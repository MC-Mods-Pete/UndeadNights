...
public class EliteZombieEntity extends ZombieEntity {
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData) {
        ...
        Objects.requireNonNull(this.getAttributeInstance(EntityAttributes.MAX_HEALTH)).addPersistentModifier(new EntityAttributeModifier(Identifier.of(UndeadNights.MOD_ID,"elite_zombie_health_bonus"), MainConfig.getMaxHealthEliteZombies() - 20.0F, EntityAttributeModifier.Operation.ADD_VALUE));

...
public class HordeZombieRenderer
    ...
    public HordeZombieRenderer(EntityRendererProvider.Context context, ModelLayerLocation adultModel, ModelLayerLocation babyModel, ModelLayerLocation innerModel, ModelLayerLocation outerModel, ModelLayerLocation innerModelBaby, ModelLayerLocation outerModelBaby) {
        super(
                context,

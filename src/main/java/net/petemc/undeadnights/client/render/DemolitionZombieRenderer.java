...
public class DemolitionZombieRenderer
    ...
    public DemolitionZombieRenderer(EntityRendererProvider.Context context, ModelLayerLocation adultModel, ModelLayerLocation babyModel, ModelLayerLocation innerModel, ModelLayerLocation outerModel, ModelLayerLocation innerModelBaby, ModelLayerLocation outerModelBaby) {
        super(
                context,
